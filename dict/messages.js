...
module.exports = {
    ...
    normal: {
        ...
        reservation_set: 'وقت شما با موفقیت رزرو شد. جهت مشاهده وضعیت درخواست خود، دکمه «تعیین وقت شوروم» را مجدداً انتخاب کنید.',
        reservation_canceled: 'درخواست شما لغو شد',
        reservation_not_free_hour: 'ساعت خالی در این روز وجود ندارد.',

        choose_city: 'لطفا نام شهری که در آن سکونت دارید را وارد کنید',
        choose_married: 'آیا متأهل هستید؟',
        choose_wanting_salary: 'میزان حقوق درخواستی خود را وارد نمایید',
        choose_fulltime: 'آیا میخواهید تمام وقت کار کنید؟',
        choose_cv: 'لطفا یک فایل با پسوند .zip جهت ارسال مدارک، رزومه، عکس و ... در همین بخش آپلود نمایید (حداکثر حجم آپلودی: 15 مگابایت)',
        file_size_exceed: 'حجم یا فرمت فایل ارسالی غیرمجاز است. لطفا مجدداً تلاش کنید.',
        recruitment_end: 'اطلاعات شما ثبت گردید. در صورت پذیرفته شدن، با شما تماس گرفته خواهد شد.',

        res : {
            intro: 'شما با مشخصات زیر درخواست تعیین وقت کرده اید:',
            accepted: `درخواست شما <i>تایید شده است.</i> بزودی با شما تماس گرفته می شود.`,
            not_yet: `درخواست شما <i>در دست بررسی</i> است.`,
            rejected: `درخواست شما <i>رد شده است.</i>`,
            responded: `درخواست تعیین وقت شوروم شما پاسخ داده شده است. جهت کسب اطلاعات بیشتر دکمه «تعیین وقت شوروم» را از منوی اصلی انتخاب نمایید.`,
        }
    }
};